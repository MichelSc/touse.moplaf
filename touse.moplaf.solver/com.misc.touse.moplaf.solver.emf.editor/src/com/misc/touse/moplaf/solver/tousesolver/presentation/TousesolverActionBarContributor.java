 ...
 * @generated
 */
public class TousesolverActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public TousesolverActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("tousesolver-settings"));
		toolBarManager.add(new Separator("tousesolver-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_TousesolverEditor_menu"), "com.misc.touse.moplaf.solver.tousesolverMenuID");
		...
		//
		createChildMenuManager = new MenuManager(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ToUserSolverEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
