...
public class DomainObjectImpl extends MinimalEObjectImpl.Container implements DomainObject {
	...
	protected EClass eStaticClass() {
		return TousesolverPackage.Literals.DOMAIN_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousesolverPackage.DOMAIN_OBJECT__NAME, oldName, name));
	}
	...
	public void setShortName(String newShortName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousesolverPackage.DOMAIN_OBJECT__SHORT_NAME, oldShortName, shortName));
	}
