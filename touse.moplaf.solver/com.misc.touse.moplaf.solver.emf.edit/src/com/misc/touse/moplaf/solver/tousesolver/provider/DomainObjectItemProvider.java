...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.solver.tousesolver.DomainObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TousesolverPackage.Literals.DOMAIN_OBJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addShortNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainObject_ShortName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainObject_ShortName_feature", "_UI_DomainObject_type"),
				 TousesolverPackage.Literals.DOMAIN_OBJECT__SHORT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DomainObject.class)) {
			case TousesolverPackage.DOMAIN_OBJECT__NAME:
			case TousesolverPackage.DOMAIN_OBJECT__SHORT_NAME:
