...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.solver.tousesolver.LpRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LpRootItemProvider
	 ...
	 * @generated
	 */
	public LpRootItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LpRoot_Item_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LpRoot_Item_feature", "_UI_LpRoot_type"),
				 TousesolverPackage.Literals.LP_ROOT__ITEM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKnapsackPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LpRoot_Knapsack_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LpRoot_Knapsack_feature", "_UI_LpRoot_type"),
				 TousesolverPackage.Literals.LP_ROOT__KNAPSACK,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TousesolverPackage.Literals.LP_ROOT__ITEM);
			childrenFeatures.add(TousesolverPackage.Literals.LP_ROOT__KNAPSACK);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LpRoot"));
	}
