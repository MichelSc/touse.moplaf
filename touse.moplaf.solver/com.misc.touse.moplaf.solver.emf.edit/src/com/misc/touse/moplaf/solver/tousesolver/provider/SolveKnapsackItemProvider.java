...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.solver.tousesolver.SolveKnapsack} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolveKnapsackItemProvider extends JobConsoleItemProvider {
	 ...
	 * @generated
	 */
	public SolveKnapsackItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SolveKnapsack)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SolveKnapsack_type") :
			getString("_UI_SolveKnapsack_type") + " " + label;
	}
