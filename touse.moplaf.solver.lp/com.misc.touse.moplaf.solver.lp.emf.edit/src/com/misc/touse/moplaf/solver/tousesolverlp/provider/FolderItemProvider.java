...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.solver.tousesolverlp.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUseSolverLpPackage.Literals.FOLDER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseSolverLpPackage.Literals.FOLDER__SUB_FOLDERS);
			childrenFeatures.add(ToUseSolverLpPackage.Literals.FOLDER__GENERATORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUseSolverLpPackage.Literals.FOLDER__SUB_FOLDERS,
				 ToUseSolverLpFactory.eINSTANCE.createFolder()));

		newChildDescriptors.add
			(createChildParameter
				(ToUseSolverLpPackage.Literals.FOLDER__GENERATORS,
				 ToUseSolverLpFactory.eINSTANCE.createToUseGenerator()));
	}
