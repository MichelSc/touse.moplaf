 ...
 * @generated
 */
public class ToUseSolverLpSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ToUseSolverLpPackage.FOLDER: {
				Folder folder = (Folder)theEObject;
				T result = caseFolder(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ToUseSolverLpPackage.TO_USE_GENERATOR: {
			...
			case ToUseSolverLpPackage.TO_USE_TUPLE: {
				ToUseTuple toUseTuple = (ToUseTuple)theEObject;
				T result = caseToUseTuple(toUseTuple);
				if (result == null) result = caseGeneratorTuple(toUseTuple);
				if (result == null) result = caseGeneratorElement(toUseTuple);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>To Use Generator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>To Use Generator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseToUseGenerator(ToUseGenerator object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>To Use Tuple</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>To Use Tuple</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
