 ...
 * @generated
 */
public class CalcResourceDistanceItemProvider extends PropagatorFunctionBindingsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcResourceDistance_Resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcResourceDistance_Resource_feature", "_UI_CalcResourceDistance_type"),
				 ToUseSchedulerPackage.Literals.CALC_RESOURCE_DISTANCE__RESOURCE,
				 true,
				 false,
				 true,
				 null,
