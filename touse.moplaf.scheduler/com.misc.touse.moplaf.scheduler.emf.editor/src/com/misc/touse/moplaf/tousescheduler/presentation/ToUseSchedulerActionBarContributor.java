 ...
 * @generated
 */
public class ToUseSchedulerActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public ToUseSchedulerActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("tousescheduler-settings"));
		toolBarManager.add(new Separator("tousescheduler-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_ToUseSchedulerEditor_menu"), "com.misc.touse.moplaf.touseschedulerMenuID");
		...
		//
		createChildMenuManager = new MenuManager(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
		submenuManager.insertBefore("additions", createSiblingMenuManager);

		// Prepare for ToUseScheduler item addition or removal.
		//
		applicationPopUpMenuManager = new MenuManager("ToUseScheduler");
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		applicationPopUpMenuActions.add(new GarbageCollectAction(activeEditorPart, selection));
		...
		applicationPopUpMenuActions.add(new SelectAction    (activeEditorPart, selection));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ToUseSchedulerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
		populateManager(submenuManager, createSiblingActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager("ToUseScheduler");
