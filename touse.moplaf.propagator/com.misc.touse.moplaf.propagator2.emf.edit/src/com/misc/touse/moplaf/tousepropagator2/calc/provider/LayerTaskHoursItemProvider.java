...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2.calc.LayerTaskHours} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerTaskHoursItemProvider extends ToUsePropagatorFunctionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalcPackage.Literals.LAYER_TASK_HOURS__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalcPackage.Literals.LAYER_TASK_HOURS__ANTECEDENT_LAYER_TASK_HOURS_ITEM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalcPackage.Literals.LAYER_TASK_HOURS__ANTECEDENT_LAYER_TASK_HOURS_VAR,
				 true,
				 false,
				 true,
				 null,
