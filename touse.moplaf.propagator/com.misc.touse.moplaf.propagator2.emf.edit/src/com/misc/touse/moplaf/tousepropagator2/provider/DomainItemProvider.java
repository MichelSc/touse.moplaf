...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUsePropagatorPackage.Literals.DOMAIN__PROJECTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Domain.class)) {
			case ToUsePropagatorPackage.DOMAIN__PROJECTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUsePropagatorPackage.Literals.DOMAIN__PROJECTS,
				 ToUsePropagatorFactory.eINSTANCE.createProject()));
	}
