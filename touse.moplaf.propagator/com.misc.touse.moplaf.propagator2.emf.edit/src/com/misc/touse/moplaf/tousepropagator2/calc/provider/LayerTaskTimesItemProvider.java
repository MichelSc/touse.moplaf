...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2.calc.LayerTaskTimes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerTaskTimesItemProvider extends ToUsePropagatorFunctionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalcPackage.Literals.LAYER_TASK_TIMES__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalcPackage.Literals.LAYER_TASK_TIMES__ANTECEDENT_LAYER_TASK_HOURS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((LayerTaskTimes)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_LayerTaskTimes_type") :
			getString("_UI_LayerTaskTimes_type") + " " + label;
	}
