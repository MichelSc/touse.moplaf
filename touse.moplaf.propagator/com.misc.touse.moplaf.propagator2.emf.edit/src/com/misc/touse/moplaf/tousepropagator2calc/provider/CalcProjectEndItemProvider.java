...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2calc.CalcProjectEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcProjectEndItemProvider extends ToUsePropagatorFunctionProjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUsePropagatorCalcPackage.Literals.CALC_PROJECT_END__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUsePropagatorCalcPackage.Literals.CALC_PROJECT_END__ANTECEDENT_LAYER_TASK_TIMES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		CalcProjectEnd calcProjectEnd = (CalcProjectEnd)object;
		return getString("_UI_CalcProjectEnd_type") + " " + calcProjectEnd.isTouched();
	}
