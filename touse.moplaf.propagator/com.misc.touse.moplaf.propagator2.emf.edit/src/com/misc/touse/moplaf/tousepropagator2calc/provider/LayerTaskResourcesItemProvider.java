...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2calc.LayerTaskResources} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerTaskResourcesItemProvider extends ToUsePropagatorFunctionProjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUsePropagatorCalcPackage.Literals.LAYER_TASK_RESOURCES__ANTECEDENT_LAYER_TASK_TIMES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUsePropagatorCalcPackage.Literals.LAYER_TASK_RESOURCES__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns LayerTaskResources.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LayerTaskResources"));
	}
	...
	public String getText(Object object) {
		LayerTaskResources layerTaskResources = (LayerTaskResources)object;
		return getString("_UI_LayerTaskResources_type") + " " + layerTaskResources.isTouched();
	}
