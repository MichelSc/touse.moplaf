...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2calc.CalcTaskHoursItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcTaskHoursItemItemProvider extends ToUsePropagatorFunctionTaskItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalcTaskHoursItemItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcTaskHoursItem_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcTaskHoursItem_ConcreteParent_feature", "_UI_CalcTaskHoursItem_type"),
				 ToUsePropagatorCalcPackage.Literals.CALC_TASK_HOURS_ITEM__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		CalcTaskHoursItem calcTaskHoursItem = (CalcTaskHoursItem)object;
		return getString("_UI_CalcTaskHoursItem_type") + " " + calcTaskHoursItem.isTouched();
	}
