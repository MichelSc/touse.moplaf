...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Layer Task Hours Var</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.moplaf.tousepropagator2calc.impl.LayerTaskHoursVarImpl#getConcreteParent <em>Concrete Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayerTaskHoursVarImpl extends ToUsePropagatorFunctionProjectImpl implements LayerTaskHoursVar {
	/**
	 ...
	 * @generated
	 */
	protected LayerTaskHoursVarImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ToUsePropagatorCalcPackage.Literals.LAYER_TASK_HOURS_VAR;
	}
		...
		if (concreteParent != null && concreteParent.eIsProxy()) {
			...
			if (concreteParent != oldConcreteParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ToUsePropagatorCalcPackage.LAYER_TASK_HOURS_VAR__CONCRETE_PARENT, oldConcreteParent, concreteParent));
			}
		}
	...
	public void setConcreteParent(ScopeProject newConcreteParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToUsePropagatorCalcPackage.LAYER_TASK_HOURS_VAR__CONCRETE_PARENT, oldConcreteParent, concreteParent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToUsePropagatorCalcPackage.LAYER_TASK_HOURS_VAR__CONCRETE_PARENT:
