...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousepropagator2calc.CalcTaskEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcTaskEndItemProvider extends ToUsePropagatorFunctionTaskItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalcTaskEndItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcTaskEnd_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcTaskEnd_ConcreteParent_feature", "_UI_CalcTaskEnd_type"),
				 ToUsePropagatorCalcPackage.Literals.CALC_TASK_END__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((CalcTaskEnd)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_CalcTaskEnd_type") :
			getString("_UI_CalcTaskEnd_type") + " " + label;
	}
