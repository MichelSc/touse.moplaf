	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ToUsePropagatorPackage.PROJECT: {
				...
				if (result == null) result = caseObjectWithPropagatorFunctionAdapter(project);
				if (result == null) result = caseObjectWithPropagatorFunctionAdapterScope(project);
			...
			case ToUsePropagatorPackage.TASK: {
				...
				if (result == null) result = caseObjectWithPropagatorFunctionAdapter(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
