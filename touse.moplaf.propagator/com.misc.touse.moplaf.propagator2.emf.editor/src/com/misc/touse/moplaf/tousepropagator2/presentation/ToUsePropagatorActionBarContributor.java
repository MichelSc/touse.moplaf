...
/**
 * This is the action bar contributor for the ToUsePropagator model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToUsePropagatorActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public ToUsePropagatorActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("tousepropagator-settings"));
		toolBarManager.add(new Separator("tousepropagator-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_ToUsePropagatorEditor_menu"), "com.misc.touse.moplaf.tousepropagatorMenuID");
		...
		//
		createChildMenuManager = new MenuManager(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
		submenuManager.insertBefore("additions", createSiblingMenuManager);

		// Prepare for ToUsePropagator item addition or removal.
		//
		applicationPopUpMenuManager = new MenuManager("ToUsePropagator");
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ToUsePropagatorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
		populateManager(submenuManager, createSiblingActions, null);
		menuManager.insertBefore("edit", submenuManager);
		
		submenuManager = new MenuManager("ToUsePropagator");
