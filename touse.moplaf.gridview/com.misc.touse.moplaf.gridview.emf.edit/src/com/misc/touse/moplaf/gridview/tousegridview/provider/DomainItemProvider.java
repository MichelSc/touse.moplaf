...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.gridview.tousegridview.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseGridViewPackage.Literals.DOMAIN__DOCUMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Domain.class)) {
			case ToUseGridViewPackage.DOMAIN__DOCUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUseGridViewPackage.Literals.DOMAIN__DOCUMENTS,
				 ToUseGridViewFactory.eINSTANCE.createDocument()));
	}
