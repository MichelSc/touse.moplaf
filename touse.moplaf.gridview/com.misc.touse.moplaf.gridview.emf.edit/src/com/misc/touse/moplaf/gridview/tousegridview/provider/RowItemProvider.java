...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.gridview.tousegridview.Row} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RowItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseGridViewPackage.Literals.ROW__CELLS);
		}
	...
	public String getText(Object object) {
		Row row = (Row)object;
		return getString("_UI_Row_type") + " " + row.getIndex();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUseGridViewPackage.Literals.ROW__CELLS,
