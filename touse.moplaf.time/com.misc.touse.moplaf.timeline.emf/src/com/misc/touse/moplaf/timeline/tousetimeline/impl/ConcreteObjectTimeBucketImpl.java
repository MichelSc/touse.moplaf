	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ObjectTimeBucket.class) {
			switch (derivedFeatureID) {
				case TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__BUCKET: return DiscretePackage.OBJECT_TIME_BUCKET__BUCKET;
				case TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__NEXT: return DiscretePackage.OBJECT_TIME_BUCKET__NEXT;
				case TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__PREVIOUS: return DiscretePackage.OBJECT_TIME_BUCKET__PREVIOUS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ObjectTimeBucket.class) {
			switch (baseFeatureID) {
				case DiscretePackage.OBJECT_TIME_BUCKET__BUCKET: return TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__BUCKET;
				case DiscretePackage.OBJECT_TIME_BUCKET__NEXT: return TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__NEXT;
				case DiscretePackage.OBJECT_TIME_BUCKET__PREVIOUS: return TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET__PREVIOUS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ObjectTimeBucket.class) {
			switch (baseOperationID) {
				case DiscretePackage.OBJECT_TIME_BUCKET___DISPOSE: return TousetimelinePackage.CONCRETE_OBJECT_TIME_BUCKET___DISPOSE;
				default: return -1;
			}
		}
