 ...
 * @generated
 */
public class ToUseTimeViewSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ToUseTimeViewPackage.DOMAIN: {
				Domain domain = (Domain)theEObject;
				T result = caseDomain(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ToUseTimeViewPackage.FOLDER: {
	 ...
	 * @generated
	 */
	public T caseObject(com.misc.touse.moplaf.timeview.tousetimeview.Object object) {
		return null;
	}
