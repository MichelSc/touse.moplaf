 ...
 * @generated
 */
public class ToUseEMFPackageImpl extends EPackageImpl implements ToUseEMFPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.misc.touse.moplaf.touseemf.ToUseEMFPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ToUseEMFPackageImpl() {
		super(eNS_URI, ToUseEMFFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ToUseEMFPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ToUseEMFPackage init() {
		if (isInited) return (ToUseEMFPackage)EPackage.Registry.INSTANCE.getEPackage(ToUseEMFPackage.eNS_URI);

		// Obtain or create and register package
		ToUseEMFPackageImpl theToUseEMFPackage = (ToUseEMFPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ToUseEMFPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ToUseEMFPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theToUseEMFPackage.createPackageContents();

		// Initialize created meta-data
		theToUseEMFPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theToUseEMFPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ToUseEMFPackage.eNS_URI, theToUseEMFPackage);
		return theToUseEMFPackage;
	}
	 ...
	 * @generated
	 */
	public ToUseEMFFactory getToUseEMFFactory() {
		return (ToUseEMFFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getFolder_Documents(), this.getDocument(), null, "Documents", null, 0, -1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
