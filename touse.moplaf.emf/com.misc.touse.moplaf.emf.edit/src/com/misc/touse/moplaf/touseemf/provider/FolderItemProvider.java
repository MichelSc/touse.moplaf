/**
 */
package com.misc.touse.moplaf.touseemf.provider;
...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.touseemf.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUseEMFPackage.Literals.FOLDER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseEMFPackage.Literals.FOLDER__DOCUMENTS);
			childrenFeatures.add(ToUseEMFPackage.Literals.FOLDER__SUB_FOLDERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUseEMFPackage.Literals.FOLDER__DOCUMENTS,
				 ToUseEMFFactory.eINSTANCE.createDocument()));

		newChildDescriptors.add
			(createChildParameter
				(ToUseEMFPackage.Literals.FOLDER__SUB_FOLDERS,
				 ToUseEMFFactory.eINSTANCE.createFolder()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ToUseEMFEditPlugin.INSTANCE;
	}
