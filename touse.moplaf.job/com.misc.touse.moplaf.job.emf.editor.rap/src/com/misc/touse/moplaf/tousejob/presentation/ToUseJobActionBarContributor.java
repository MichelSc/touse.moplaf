...
import com.misc.common.moplaf.file.presentation.FileUploadAction;
...
public class ToUseJobActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(TousejobEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(TousejobEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public ToUseJobActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("tousejob-settings"));
		toolBarManager.add(new Separator("tousejob-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(TousejobEditorPlugin.INSTANCE.getString("_UI_ToUseJobEditor_menu"), "com.misc.touse.moplaf.tousejobMenuID");
		...
		//
		createChildMenuManager = new MenuManager(TousejobEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		AdapterFactory adapterFactory = ((ToUseJobEditor)activeEditorPart).getAdapterFactory();
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(TousejobEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
