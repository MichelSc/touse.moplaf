...
import com.misc.touse.moplaf.tousejob.presentation.TousejobEditorPlugin;
 ...
 * @generated
 */
public final class TousejobEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = ToUseJobEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 
	...
	private static String getString(String key) {
		return TousejobEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return com.misc.touse.moplaf.tousejob.presentation.TousejobEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new TousejobEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "com.misc.touse.moplaf.tousejob.presentation.TousejobEditorAdvisorPerspective";
...
//			right.addView("org.eclipse.ui.console.ConsoleView");
			...
			bottonRight.addView("com.misc.common.moplaf.gridview.views.GridView");
		}
	}
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			...
			String aboutText = "Version 20180218a, Ordina 2018, https://www.ordina.be/ \n\n"
			         + "Built on Moplaf version 1.1, https://rawgit.com/MichelSc/common.moplaf/master/moplaf/moplaf.html \n\n"
			         + "Using eclipse Oxygen version 4.7, https://eclipse.org \n\n"
                     ;
			MessageDialog.openInformation(getWindow().getShell(), aboutTitle, aboutText);
		}
	}
	
	/**
	 * Open action for the objects from the Tousejob model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Tousejob model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
