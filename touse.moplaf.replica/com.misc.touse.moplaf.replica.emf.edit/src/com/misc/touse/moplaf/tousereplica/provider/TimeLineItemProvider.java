...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousereplica.TimeLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeLineItemProvider extends TimeLineAbstractItemProvider {
	/**
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TimeLine_Code_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TimeLine_Code_feature",
								"_UI_TimeLine_type"),
						ToUseReplicaPackage.Literals.TIME_LINE__CODE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseReplicaPackage.Literals.TIME_LINE__BUCKETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ToUseReplicaPackage.Literals.TIME_LINE__BUCKETS,
				ToUseReplicaFactory.eINSTANCE.createTimeLineBucket()));
	}
