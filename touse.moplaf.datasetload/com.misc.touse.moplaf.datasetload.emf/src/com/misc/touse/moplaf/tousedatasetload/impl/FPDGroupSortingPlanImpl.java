 ...
 * <ul>
 *   <li>{@link com.misc.touse.moplaf.tousedatasetload.impl.FPDGroupSortingPlanImpl#getFromDate <em>From Date</em>}</li>
 *   <li>{@link com.misc.touse.moplaf.tousedatasetload.impl.FPDGroupSortingPlanImpl#getToDate <em>To Date</em>}</li>
 *   <li>{@link com.misc.touse.moplaf.tousedatasetload.impl.FPDGroupSortingPlanImpl#getSortingPlansTable <em>Sorting Plans Table</em>}</li>
 *   <li>{@link com.misc.touse.moplaf.tousedatasetload.impl.FPDGroupSortingPlanImpl#getSortingPlanInputsTable <em>Sorting Plan Inputs Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FPDGroupSortingPlanImpl extends TableGroupImpl implements FPDGroupSortingPlan {
	...
	protected EClass eStaticClass() {
		return TousedatasetloadPackage.Literals.FPD_GROUP_SORTING_PLAN;
	}
	...
	public void setFromDate(Date newFromDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__FROM_DATE, oldFromDate, fromDate));
	}
	...
	public void setToDate(Date newToDate) {
		...
		toDate = newToDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__TO_DATE, oldToDate, toDate));
	}
	...
	public NotificationChain basicSetSortingPlansTable(FPDSortingPlans newSortingPlansTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLANS_TABLE, oldSortingPlansTable, newSortingPlansTable);
	...
	public void setSortingPlansTable(FPDSortingPlans newSortingPlansTable) {
		if (newSortingPlansTable != sortingPlansTable) {
			...
			if (sortingPlansTable != null)
				msgs = ((InternalEObject)sortingPlansTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLANS_TABLE, null, msgs);
			if (newSortingPlansTable != null)
				msgs = ((InternalEObject)newSortingPlansTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLANS_TABLE, null, msgs);
			msgs = basicSetSortingPlansTable(newSortingPlansTable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLANS_TABLE, newSortingPlansTable, newSortingPlansTable));
	}
	...
	public NotificationChain basicSetSortingPlanInputsTable(FPDSortingPlanInputs newSortingPlanInputsTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLAN_INPUTS_TABLE, oldSortingPlanInputsTable, newSortingPlanInputsTable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSortingPlanInputsTable(FPDSortingPlanInputs newSortingPlanInputsTable) {
		if (newSortingPlanInputsTable != sortingPlanInputsTable) {
			...
			if (sortingPlanInputsTable != null)
				msgs = ((InternalEObject)sortingPlanInputsTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLAN_INPUTS_TABLE, null, msgs);
			if (newSortingPlanInputsTable != null)
				msgs = ((InternalEObject)newSortingPlanInputsTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLAN_INPUTS_TABLE, null, msgs);
			msgs = basicSetSortingPlanInputsTable(newSortingPlanInputsTable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TousedatasetloadPackage.FPD_GROUP_SORTING_PLAN__SORTING_PLAN_INPUTS_TABLE, newSortingPlanInputsTable, newSortingPlanInputsTable));
	}
