...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.tousedatasetload.FPDSortingPlanInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FPDSortingPlanInputItemProvider extends TableRowItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TousedatasetloadPackage.Literals.FPD_SORTING_PLAN_INPUT__PRODUCT_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TousedatasetloadPackage.Literals.FPD_SORTING_PLAN_INPUT__SORTING_PLAN_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		FPDSortingPlanInput fpdSortingPlanInput = (FPDSortingPlanInput)object;
		return getString("_UI_FPDSortingPlanInput_type") + " " + fpdSortingPlanInput.getRowNumber();
	}
