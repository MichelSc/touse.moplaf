...
/**
 * This is the item provider adapter for a {@link com.misc.touse.moplaf.report.ToUseReport.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToUseReportPackage.Literals.FOLDER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToUseReportPackage.Literals.FOLDER__AS);
			childrenFeatures.add(ToUseReportPackage.Literals.FOLDER__SUB_FOLDERS);
			childrenFeatures.add(ToUseReportPackage.Literals.FOLDER__REPORTA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToUseReportPackage.Literals.FOLDER__AS,
				 ToUseReportFactory.eINSTANCE.createA()));

		newChildDescriptors.add
			(createChildParameter
				(ToUseReportPackage.Literals.FOLDER__SUB_FOLDERS,
				 ToUseReportFactory.eINSTANCE.createFolder()));

		newChildDescriptors.add
			(createChildParameter
				(ToUseReportPackage.Literals.FOLDER__REPORTA,
				 ToUseReportFactory.eINSTANCE.createReportA()));
	}
