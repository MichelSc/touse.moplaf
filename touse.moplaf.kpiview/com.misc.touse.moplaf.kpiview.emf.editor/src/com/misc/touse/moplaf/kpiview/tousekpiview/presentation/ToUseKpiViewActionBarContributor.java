...
public class ToUseKpiViewActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("tousekpiview-settings"));
		toolBarManager.add(new Separator("tousekpiview-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		//
		createChildMenuManager = new MenuManager(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(TousekpiviewEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
