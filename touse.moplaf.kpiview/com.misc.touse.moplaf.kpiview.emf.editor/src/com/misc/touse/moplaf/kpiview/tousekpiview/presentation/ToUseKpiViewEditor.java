/**
 */
package com.misc.touse.moplaf.kpiview.tousekpiview.presentation;
...
/**
 * This is an example of a ToUseKpiView model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToUseKpiViewEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(ToUseKpiViewModelWizard.FILE_EXTENSIONS, "*.");
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(ToUseKpiViewEditor.this);
				...
				else if (p == ToUseKpiViewEditor.this) {
					handleActivate();
				}
			}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(ToUseKpiViewEditor.this, false);
			}
			else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "com.misc.touse.moplaf.kpiview.emf.editor",
					 0,
					 null,
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new ToUseKpiViewItemProviderAdapterFactory());
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), ToUseKpiViewEditor.this) {
						@Override
		...
		PropertySheetPage propertySheetPage =
			new ExtendedPropertySheetPage(editingDomain) {
				...
				public void setSelectionToViewer(List<?> selection) {
					ToUseKpiViewEditor.this.setSelectionToViewer(selection);
					ToUseKpiViewEditor.this.setFocus();
				}
	...
	public void doSaveAs() {
		...
		String[] files = TousekpiviewEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return TousekpiviewEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return TousekpiviewEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
